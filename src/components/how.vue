  ...
  <div class="home-body">
    <div class="container">
    			...
    			<div class="st-container">
    				...
    				<a href="#st-panel-1">Welcome</a>
    				<input type="radio" name="radio-set" id="st-control-2"/>
    				<a href="#st-panel-2">Happiness</a>
    				<input type="radio" name="radio-set" id="st-control-3"/>
    				<a href="#st-panel-3">Split</a>
                ...
                <i class="far fa-handshake st-deco-icon"></i>
    						<h2 style="font-size: 2rem;">Welcome<br> <small>to </small><br> <strong style="font-size: 5rem;line-height: 7rem;color: #642B73"> UncleBob </strong> </h2><br>
    					...
    					<section class="st-panel st-color" id="st-panel-2">
    						<div class="st-deco"></div>
                <i class="far fa-handshake st-deco-icon-2"></i>
    						<h2>Happiness</h2>
